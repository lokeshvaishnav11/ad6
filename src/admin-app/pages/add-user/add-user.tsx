...
//               <div className="text-right mb-2 d-flex items-center justify-between  p-2 rounded " style={{background:"rgb(5, 42, 81)"}}>
...
const AddUser = () => {
  ...
  const onSubmit = handleSubmit((data) => {
    ...
    if (data.role !== RoleType.user) {
      ...
      // Sub Admin ke liye Min/Max manually bharne ki zarurat nahi.
      // Existing screen mapping:
      // sportId 1 = Match, sportId 2 = Fancy, sportId 4 = Casino
      if (thetype === "sadmin") {
        userSettingArr[1] = {
          minBet: 0,
          maxBet: 200000,
          delay: userData?.userSetting?.[1]?.delay ?? 0,
        };
        userSettingArr[2] = {
          minBet: 0,
          maxBet: 50000,
          delay: userData?.userSetting?.[2]?.delay ?? 0,
        };
        userSettingArr[4] = {
          minBet: 0,
          maxBet: 10000,
          delay: userData?.userSetting?.[4]?.delay ?? 0,
        };
      } else {
                  ...
                  <div className="col-md-6 account-detail">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                       ...
                       <div className="col-md-6">
                        <div className="form-group">
                          <label htmlFor="cacom">Casino Commision</label>
                          <input
                            className="form-control"
