      ...
      <div className='container-fluid'>
        <div className='row'>
          <div className={!isMobile ? 'col-md-12 mt-1' : 'col-md-12 padding-custom'}>
            ...
            <div className='bg-full'>Report </div>

            <div className="table-container">
      {/* <div className="bg-full title">Commision Len Den</div> */}
      <div className="date-filters" style={{ display: showTable ? 'flex' : 'flex' }}>
      ...
      {showTable && (
        <div className="table-wrapper">
          <table className="commission-table">
            ...
            <tbody>
              <tr>
                <td>INFAYOUD (SA0023)</td>
                <td className="negative">-9178689.02</td>
                <td className="positive">11359386.56</td>
                <td className="positive">2180697.54</td>
                <td>457302.93</td>
                <td>10894863.75</td>
                <td>11352166.68</td>
                <td className="negative">-9171469.14</td>
                <td className="negative">-6878601.82</td>
                <td className="negative">-2292867.28</td>
              </tr>
