...
const Casinowar = (props: any) => {
  ...
  const cardImageUrl = 'https://versionobj.ecoassetsservice.com/v38/static/front/img/cards/';
      ...
      <div className='row casino-32A '>
          {lastOdds && isMobile? <div className='col-lg-12 col-12 main-market' style={{ padding: '0px' }}><div className='card-inner card-dtl-mobile'> <div className='d-flex'>
            <div>
              <img
              style={{width:"25px"}}
                src={`https://versionobj.ecoassetsservice.com/v38/static/front/img/cards/${lastOdds?.['cards']?.C1}.png`}
              />
            </div>
            <div>
              <img
              style={{width:"25px"}}
                src={`https://versionobj.ecoassetsservice.com/v38/static/front/img/cards/${lastOdds?.['cards']?.C2}.png`}
              />
            </div>
            <div>
              <img
              style={{width:"25px"}}
                src={`https://versionobj.ecoassetsservice.com/v38/static/front/img/cards/${lastOdds?.['cards']?.C3}.png`}
              />
            </div>
            <div>
              <img
              style={{width:"25px"}}
                src={`https://versionobj.ecoassetsservice.com/v38/static/front/img/cards/${lastOdds?.['cards']?.C4}.png`}
              />
            </div>
            <div>
              <img
              style={{width:"25px"}}
                src={`https://versionobj.ecoassetsservice.com/v38/static/front/img/cards/${lastOdds?.['cards']?.C5}.png`}
              />
            </div>
            <div>
              <img
              style={{width:"25px"}}
                src={`https://versionobj.ecoassetsservice.com/v38/static/front/img/cards/${lastOdds?.['cards']?.C6}.png`}
              />
            </div>
          </div></div></div> : ""}
