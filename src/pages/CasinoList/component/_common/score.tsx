              ...
              <div className='mobile-flex'>
                {scoreData && scoreData.teamA ? (
                  <p key={scoreData.teamA.name} className='team-1 d-flex  m-t-10'>
                    <span style={{color:"white"}} className='team-name col-md-3 pl10'>{scoreData.teamA.name}</span>
                ...
                {scoreData && scoreData.teamB ? (
                  <p key={scoreData.teamB.name} className='team-1 d-flex m-t-10'>
                    <span style={{color:"white"}} className='team-name col-md-3 pl10'>{scoreData.teamB.name}</span>
            ...
            <div className='col-md-7 col-12'>
              <div className='row'>
                <div className='col-md-5 col-4'>
                  <div className='row'>
                    <span  className='team-name mobilescorcard' style={{ paddingTop: '10px', color:"white" }}>
